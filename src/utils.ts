...
export function renderCurve(
  ...
  curve.tag.forEach(function (tag, i): void {
    ...
    if (tag === 'CURVE') {
      path.push(
        'C ' +
          fixed(p0.x * scale.x + trans.x) +
          ' ' +
          fixed(p0.y * scale.y + trans.y) +
          ', ' +
          fixed(p1.x * scale.x + trans.x) +
          ' ' +
          fixed(p1.y * scale.y + trans.y) +
          ', ' +
          fixed(p2.x * scale.x + trans.x) +
          ' ' +
          fixed(p2.y * scale.y + trans.y),
      );
    } else if (tag === 'CORNER') {
      path.push(
        'L ' +
